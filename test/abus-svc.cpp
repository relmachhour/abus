...
class AbusReqTest : public AbusTest {
    protected:
        virtual void SetUp() {
	        ...
	        json_rpc_ = abus_request_method_init(abus_, SVC_NAME, "sum");
...
class AbusJtypesTest : public AbusTest {
    protected:
        virtual void SetUp() {
	        ...
	        json_rpc_ = abus_request_method_init(abus_, SVC_NAME, "jtypes");
	        EXPECT_TRUE(NULL != json_rpc_);
        }
        virtual void TearDown() {
...
class AbusArrayTest : public AbusTest {
    protected:
        virtual void SetUp() {
	        ...
	        json_rpc_ = abus_request_method_init(abus_, SVC_NAME, "sqr");
	        EXPECT_TRUE(NULL != json_rpc_);
        }
        virtual void TearDown() {
...
class AbusEchoTest : public AbusTest {
    protected:
        virtual void SetUp() {
	        ...
	        json_rpc_ = abus_request_method_init(abus_, SVC_NAME, "echo");
	        EXPECT_TRUE(NULL != json_rpc_);
        }
        virtual void TearDown() {
...
TEST_F(AbusReqTest, PlentyOfMethods) {
    ...
    /* Huge introspection */
    json_rpc_introspect = abus_request_method_init(abus_, SVC_NAME, "*");
    EXPECT_TRUE(NULL != json_rpc_introspect);
...
TEST_F(AbusReqTest, PlentyOfServices) {
	...
	for (int i=0; i<plenty_count; i++) {
		...
		json_rpc_plenty = abus_request_method_init(abus_, service_name, "sum2");
		EXPECT_TRUE(NULL != json_rpc_plenty);
...
TEST_F(AbusTest, NoService) {
	...
	json_rpc = abus_request_method_init(abus_, "no_such_"SVC_NAME, "sum");
...
TEST_F(AbusTest, NoMethod) {
	...
	json_rpc = abus_request_method_init(abus_, SVC_NAME, "no_such_method");
	EXPECT_TRUE(NULL != json_rpc);
